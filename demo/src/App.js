...
const data = [ // 返回数据
  {
    ...
    belong: [
      ...
      {
        createdAt: 1608628155377,
        id: 1027507448841390,
        name: "南方区域",
        type: "region",
      },
      {
        createdAt: 1608628161493,
        id: 1027507498943773,
        name: "东莞",
        type: "region",
      },
...
function App() {
  ...
  const props = {
    name: "file",
    action:
      "https://www.fastmock.site/mock/541c77bf52ac9530f9e22d855c2e220e/excel/api/excel", //上传的地址
